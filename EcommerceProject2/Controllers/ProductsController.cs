...
namespace EcommerceProject2.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            var entities = new EcommerceDBEntities1();
        ...
        {
            EcommerceDBEntities1 entities = new EcommerceDBEntities1();
        ...
        public ActionResult Products(Products product, HttpPostedFileBase img)
        {
            ...
            using (var entities = new EcommerceDBEntities1())
            {
        ...
        {
            using (EcommerceDBEntities1 entities = new EcommerceDBEntities1())
            {
